...
export default class StartScreen extends GameScreen{
    ...
    initScene(){
        ...
        let hero = new BaseSprite(this.game.settings['path']['img'] + 'win/sova-2.svg','hero-1','win',550,360,240,210,' ');
		//let text = new BaseSprite(this.game.settings['path']['img'] + 'win/molodec.svg','ok-text','win',120,50,588,82,' ');
