...
export class MainScreen extends GameScreen{
    ...
    prepareRound()
    {
        ...
        if(this.hero){
            ...
            this.tweens['tweenHero'] = gsap.to(hero, {_y : this.game.getScaled(hero._y - 50), duration : 5, repeat: -1, yoyo:true});
        }
        ...
        this.tweens['tweenBasket'] = gsap.to(basket, {_x : this.game.getScaled(basket._x - 50), duration : 3, repeat: -1, yoyo:true});
