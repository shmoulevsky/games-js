...
export default class MainScreen extends GameScreen{
    ...
    constructor(bgImg, game, width = 800, height = 600){
        ...
        this.game.secondsShort = game.settings['round_short'];
    ...
    prepareRound()
    {
        ...
        this.game.secondsShort = this.game.defaultSecondShort;
    ...
    render(){
        ...
        this.game.ctx.fillRect(0, 0, 800 - ((800 / this.game.defaultSecondShort) * this.game.secondsShort), 10);
